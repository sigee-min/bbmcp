...
import type { S3BlobStoreConfig } from '@ashfox/gateway-persistence/config';
import { S3BlobStore, type S3ClientLike } from '@ashfox/gateway-persistence/infrastructure/S3BlobStore';
