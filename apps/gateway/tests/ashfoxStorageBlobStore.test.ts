...
import type { AshfoxBlobStoreConfig } from '@ashfox/gateway-persistence/config';
import { AshfoxStorageBlobStore } from '@ashfox/gateway-persistence/infrastructure/AshfoxStorageBlobStore';
